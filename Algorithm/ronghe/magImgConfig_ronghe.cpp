...
#define LM_ADJUST			12
#define RM_ADJUST			-12
#define LMM_ADJUST			16
#define RMM_ADJUST			-16
...
struct tagMagSensorZone_Foreign gMagSensorZone_Foreign[TDN_MAX] =
{
	...
	{ gMagSensorZone_Foreign + 17, NULL, NULL, TDN_LMM, MAG_ZONE_LOCATION, 254 + LMM_ADJUST, 20, MM_WHEEL_OFFSET },		//LSM
	{ gMagSensorZone_Foreign + 18, NULL, NULL, TDN_LMM1, MAG_ZONE_LOCATION, 274 + LMM_ADJUST, 20, MM_WHEEL_OFFSET },		//RSM
	{ gMagSensorZone_Foreign + 19, NULL, NULL, TDN_RMM1, MAG_ZONE_LOCATION, 427 + RMM_ADJUST, 20, MM_WHEEL_OFFSET },		//LSM
	{ NULL, NULL, NULL, TDN_RMM, MAG_ZONE_LOCATION, 447 + RMM_ADJUST, 20, MM_WHEEL_OFFSET },		//RSM
	//   141	571
	//{ gMagSensorZone_Foreign + 21, NULL, NULL, CPU_IRLC, MAG_MATH_LOCATION, 141, 8, 63 },	//LOCATINO1
	//{ NULL, NULL, NULL, CPU_IRRC, MAG_MATH_LOCATION, 571, 8, 63 },	//LOCATINO2
