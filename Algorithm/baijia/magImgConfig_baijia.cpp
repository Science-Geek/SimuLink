...
#define MM_WHEEL_OFFSET		-60
#define LM_WHEEL_OFFSET		74
#define RM_WHEEL_OFFSET		74
#define LM_ADJUST			4
#define RM_ADJUST			-4
...
struct tagMagSensorZone_Foreign gMagSensorZone_Foreign[TDN_MAX] =
{
	...
	{ gMagSensorZone_Foreign + 19, NULL, NULL, TDN_RMM, MAG_ZONE_LOCATION, 427, 20, MM_WHEEL_OFFSET },		//LSM
	{ NULL, NULL, NULL, TDN_RMM1, MAG_ZONE_LOCATION, 447, 20, MM_WHEEL_OFFSET },		//RSM
	//   141	571
