...
#define LM_WHEEL_OFFSET		47
#define RM_WHEEL_OFFSET		47
#define LM_ADJUST			-18		//越创位置
#define RM_ADJUST			18		//越创位置
#define	MM_ZONE				20
...
struct tagMagSensorZone_Foreign gMagSensorZone_Foreign[TDN_MAX] =
{
	...
	{ gMagSensorZone_Foreign + 1, NULL, NULL, TDN_LM1, MAG_ZONE_LOCATION, 88 + LM_ADJUST, MM_ZONE, LM_WHEEL_OFFSET },		//LM2
	{ gMagSensorZone_Foreign + 2, NULL, NULL, TDN_LM2, MAG_ZONE_LOCATION, 108 + LM_ADJUST, MM_ZONE, LM_WHEEL_OFFSET },		//LM3
	{ gMagSensorZone_Foreign + 3, NULL, NULL, TDN_LM3, MAG_ZONE_LOCATION, 147 + LM_ADJUST, MM_ZONE, LM_WHEEL_OFFSET },		//LM4
	{ gMagSensorZone_Foreign + 4, NULL, NULL, TDN_LM4, MAG_ZONE_LOCATION, 167 + LM_ADJUST, MM_ZONE, LM_WHEEL_OFFSET },		//LM5
	{ gMagSensorZone_Foreign + 5, NULL, NULL, TDN_LM5, MAG_ZONE_LOCATION, 206 + LM_ADJUST, MM_ZONE, LM_WHEEL_OFFSET },		//LM6
	{ gMagSensorZone_Foreign + 6, NULL, NULL, TDN_LM6, MAG_ZONE_LOCATION, 226 + LM_ADJUST, MM_ZONE, LM_WHEEL_OFFSET },		//LM7

	{ gMagSensorZone_Foreign + 7, NULL, NULL, TDN_RM1, MAG_ZONE_LOCATION, 612 + RM_ADJUST, MM_ZONE, RM_WHEEL_OFFSET },	//RM2
	{ gMagSensorZone_Foreign + 8, NULL, NULL, TDN_RM2, MAG_ZONE_LOCATION, 592 + RM_ADJUST, MM_ZONE, RM_WHEEL_OFFSET },	//RM3
	{ gMagSensorZone_Foreign + 9, NULL, NULL, TDN_RM3, MAG_ZONE_LOCATION, 553 + RM_ADJUST, MM_ZONE, RM_WHEEL_OFFSET },	//RM4
	{ gMagSensorZone_Foreign + 10, NULL, NULL, TDN_RM4, MAG_ZONE_LOCATION, 533 + RM_ADJUST, MM_ZONE, RM_WHEEL_OFFSET },	//RM5
	{ gMagSensorZone_Foreign + 11, NULL, NULL, TDN_RM5, MAG_ZONE_LOCATION, 494 + RM_ADJUST, MM_ZONE, RM_WHEEL_OFFSET },	//RM6
	{ gMagSensorZone_Foreign + 12, NULL, NULL, TDN_RM6, MAG_ZONE_LOCATION, 474 + RM_ADJUST, MM_ZONE, RM_WHEEL_OFFSET },	//RM7  

	{ gMagSensorZone_Foreign + 13, NULL, NULL, TDN_LMM, MAG_ZONE_LOCATION, 260, MM_ZONE, MM_WHEEL_OFFSET },		//LSM
	{ gMagSensorZone_Foreign + 14, NULL, NULL, TDN_LMM1, MAG_ZONE_LOCATION, 322, MM_ZONE, MM_WHEEL_OFFSET },		//RSM
	{ gMagSensorZone_Foreign + 15, NULL, NULL, TDN_RMM1, MAG_ZONE_LOCATION, 378, MM_ZONE, MM_WHEEL_OFFSET },		//LSM
	{ NULL, NULL, NULL, TDN_RMM, MAG_ZONE_LOCATION, 441, MM_ZONE, MM_WHEEL_OFFSET },		//RSM
